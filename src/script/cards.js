const cardBody = {
  ...
  },
  {
      ...
      descricao: "Não é preciso ir muito longe da capital para se aventurar pelas trilhas maravilhosas do estado do Rio de Janeiro. E uma das opções mais conhecidas por lá é o Morro Dois Irmãos.",
      imagem: "./images/morroDoisIrmaosRJ.jpg",
      link: "MorroDoisIrmaos.html",
      moreHide: "  Pois, o local proporciona uma vista incrível da cidade maravilhosa, logo, também se destaca entre as melhores trilhas do Brasil. Com duração de duas horas e um grau de dificuldade relativamente fácil. Uma dica importante, é que você vá entre os meses de maio e setembro, quando o calor dá uma amenizada.",
  ...
  },
  {
      ...
      descricao: "Visitantes do Brasil e de outras partes do mundo vão até Goiás (GO) para ver de perto a fauna, a flora, as cavernas, cânions, cachoeiras e outras riquezas da Chapada dos Veadeiros.",
      imagem: "./images/chapadaVeaderosGO.jpg",
      link: "ChapadaVeadeiros.html",
      moreHide: " Durante o ano inteiro, as belezas naturais do local atraem pessoas interessadas nas suas várias trilhas, como as que levam ao Vale da Lua, ao Cânion 2 e às cachoeiras do Rio Preto, dos Cristais e a dos Cariocas. Requer condicionamento físico, pois tende a ser longa, acidentada e cansativa.",
    ...
    let cardHtml = `
          <div class="col mb-4 shadow-lg">
              <div class="card">
                  ...
                  <div class="card-body" style="min-heigth: fit-content;">
